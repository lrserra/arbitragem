                        ...
                        if (vou_pagar > Util.retorna_menor_valor_compra(ativo)) and (qtdNegociada > Util.retorna_menor_quantidade_venda(ativo)):
                            ...
                            if (corretoraCompra.saldo['brl'] >= vou_pagar) and (corretoraVenda.saldo[ativo] >= qtdNegociada): 
                                ...
                                if executarOrdens:
                                    ...
                                    GoogleSheets().escrever_operacao(ativo,corretoraCompra.nome,comprei_a,quantidade_executada_compra,corretoraVenda.nome,vendi_a,quantidade_executada_venda,pnl_real,'ARBITRAGEM',str(datetime.now()))
                            ...
                            if (corretoraCompra.saldo[paridade] >= vou_pagar_em_paridade) and (corretoraVenda.saldo[ativo] >= qtdNegociada): 
                                ...
                                if executarOrdens:
                                    ...
                                    if ordem_compra.status != ordem_compra.descricao_status_executado:
                                        ...
                                        google_sheets.escrever_operacao('{}|{}|{}|C|{}|{}|{}|{}'.format(ativo,corretoraCompra.nome,ordem_compra.preco_executado,round(qtdNegociada,4),pnl_real/2,'ARBITRAGEM',datetime.now()))
                                    ...
                                    if ordem_venda.status != ordem_venda.descricao_status_executado:
                                        ...
                                        google_sheets.escrever_operacao('{}|{}|{}|V|{}|{}|{}|{}'.format(ativo,corretoraVenda.nome,ordem_venda.preco_executado,round(qtdNegociada,4),pnl_real/2,'ARBITRAGEM',datetime.now()))
