        ...
        for moeda in lista_de_moedas:
            try:
                ...
                if dict_leilao_compra[moeda]['zeragem'].id != 0:
                    ...
                    google_sheets.escrever_operacao(moeda,CorretoraMaisLiquida.nome,comprei_a,quantidade_executada_compra,CorretoraMenosLiquida.nome,vendi_a,quantidade_executada_venda,pnl,'LEILAO',str(datetime.now()))
                ...
                if  dict_leilao_venda[moeda]['zeragem'].id != 0:
                    ...
                    google_sheets.escrever_operacao(moeda,CorretoraMenosLiquida.nome,comprei_a,quantidade_executada_compra,CorretoraMaisLiquida.nome,vendi_a,quantidade_executada_venda,pnl,'LEILAO',str(datetime.now()))
